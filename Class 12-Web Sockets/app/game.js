//event emitter 
//"events" is a node package that can be used in the browser
const { EventEmitter} = require("events");
// unique identifier npm install uuid
const { v4: uuidv4 } = require("uuid");


// makes it so you dont go off the edges
...
module.exports = class Game extends EventEmitter {
    constructor(columns, rows) {
        super();
        // invokes event emitter inheritance chain
    ...
    draw(p, cellWidth, cellHeight) {
        ...
        p.strokeWeight(0);
        p.colorMode(p.HSB);
        //since its an object not an array
